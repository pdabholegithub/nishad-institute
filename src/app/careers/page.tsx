          ...
          <div className="space-y-8 text-slate-600 dark:text-slate-300">
            ...
            <section className="not-prose">
              ...
              <div className="space-y-4">
                {jobs.map((job, i) => (
                  <div key={i} className="group p-6 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-blue-500 dark:hover:border-blue-500 transition-all bg-white dark:bg-slate-900/50">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="font-bold text-lg text-slate-900 dark:text-white">{job.title}</h3>
                      <span className="text-[10px] px-2 py-1 rounded bg-blue-50 dark:bg-blue-900/30 text-blue-600 font-bold uppercase tracking-wider">
                        {job.type}
                      </span>
                    </div>
